              ...
              <ul className="relative z-10 grid grid-cols-6 gap-3">
                ...
                <li className="col-span-full list-none lg:col-span-2">
                  <div className="relative h-full rounded-[1.25rem] border-[0.75px] border-gray-800 p-2 md:rounded-[1.5rem] md:p-3">
                    ...
                    <div className="relative flex h-24 w-56 items-center">
                      <svg className="text-neutral-600 absolute inset-0 size-full" viewBox="0 0 254 104" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                      ...
                      <span className="mx-auto block w-fit text-5xl font-semibold text-white">Instant</span>
                    </div>
                    <h2 className="mt-6 text-center text-3xl font-semibold text-white">Automated Payouts</h2>
                      </CardContent>
                    </div>
                  </div>
                </li>
                ...
                <li className="col-span-full list-none sm:col-span-3 lg:col-span-2">
                  <div className="relative h-full rounded-[1.25rem] border-[0.75px] border-gray-800 p-2 md:rounded-[1.5rem] md:p-3">
                    ...
                    <div className="relative mx-auto flex aspect-square size-32 rounded-full border border-gray-800 before:absolute before:-inset-2 before:rounded-full before:border before:border-gray-800/50">
                      <svg className="m-auto h-fit w-24 text-emerald-400" viewBox="0 0 212 143" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                    ...
                    <div className="relative z-10 mt-6 space-y-2 text-center">
                      <h2 className="text-lg font-medium transition text-white">Oracle-Verified Data</h2>
                      <p className="text-neutral-300">Switchboard oracles provide real-time, multi-source flight data with freshness checks.</p>
                    </div>
                      </CardContent>
                    </div>
                  </div>
                ...
                <li className="col-span-full list-none sm:col-span-3 lg:col-span-2">
                  <div className="relative h-full rounded-[1.25rem] border-[0.75px] border-gray-800 p-2 md:rounded-[1.5rem] md:p-3">
                    ...
                    <div className="pt-6 lg:px-6">
                      <svg className="w-full text-amber-400" viewBox="0 0 386 123" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect width="386" height="123" rx="10" />
                        <g clipPath="url(#clip0_0_106)">
                          <circle className="text-amber-400" cx="29" cy="29" r="15" fill="currentColor" />
                    ...
                    <div className="relative z-10 mt-14 space-y-2 text-center">
                      <h2 className="text-lg font-medium transition text-white">Transparent On-Chain</h2>
                      <p className="text-neutral-300">All policy terms, oracle checks, and payouts are auditable on-chain. Complete transparency.</p>
                    </div>
                      </CardContent>
                    </div>
                  </div>
                  ...
                  <div className="relative h-full rounded-[1.25rem] border-[0.75px] border-gray-800 p-2 md:rounded-[1.5rem] md:p-3">
                    ...
                    <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                      <div className="relative flex aspect-square size-12 rounded-full border border-gray-800 before:absolute before:-inset-2 before:rounded-full before:border before:border-gray-800/50">
                        <Globe className="m-auto size-5 text-indigo-400" strokeWidth={1} />
                      </div>
                      <div className="space-y-2">
                        <h2 className="text-lg font-medium transition text-white">Community Ownership</h2>
                        <p className="text-neutral-300">Democratic governance and surplus redistribution align incentives with travelers.</p>
                      </div>
                    </div>
                ...
                <li className="col-span-full list-none lg:col-span-3">
                  <div className="relative h-full rounded-[1.25rem] border-[0.75px] border-gray-800 p-2 md:rounded-[1.5rem] md:p-3">
                    ...
                    <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                      <div className="relative flex aspect-square size-12 rounded-full border border-gray-800 before:absolute before:-inset-2 before:rounded-full before:border before:border-gray-800/50">
                        <Plane className="m-auto size-6 text-cyan-400" strokeWidth={1} />
                      </div>
                      <div className="space-y-2">
                        <h2 className="text-lg font-medium transition text-white">Global Flight Coverage</h2>
                        <p className="text-neutral-300">Protect flights worldwide with instant, automated coverage.</p>
                      </div>
                    </div>
                    <div className="relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px before:bg-gray-800 sm:-my-6 sm:-mr-6">
                      <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                          <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm text-white border-gray-800">24/7</span>
                        ...
                        <div className="relative ml-[calc(50%-1rem)] flex items-center gap-2">
                          ...
                          <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm text-white border-gray-800">Worldwide</span>
                        </div>
                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                          <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm text-white border-gray-800">Instant</span>
                          <div className="size-7 ring-4 ring-black">
