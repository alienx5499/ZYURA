...
export default function TetrisLoading({ 
  ...
  return (
    <div>
      <div>
        <div className={`border-2 border-gray-200 dark:border-gray-800 bg-black dark:bg-black ${config.padding} transition-colors`}>
          {renderGrid()}
        </div>
      </div>
      ...
      {showLoadingText && (
        <div className="text-center">
          <p className="text-white dark:text-white text-sm font-light transition-colors">{loadingText}</p>
        </div>
      )}
    </div>
  )
